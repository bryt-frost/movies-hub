        ...
        {movies?.map((movie) => (
          <div key={movie.id} className='flex-full min-w-0 relative'>
            <Image
              ...
              height={1080}
            />
            <div className='hidden lg:inline absolute top-0 pt-40 xl:pt-72 left-0 bg-transparent  z-10 h-full w-gull bg-gradient-to-r from-gray-900/90 via-transparent to-transparent p-10 space-y-5 text-white '>
